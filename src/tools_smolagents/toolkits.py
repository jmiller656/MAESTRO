from src.tools_smolagents import calendar, email, analytics, project_management, customer_relationship_manager, company_directory
from src.tools_smolagents.tracking import wrap_tool, create_function_tracker

GLOBAL_TOOL_TRACKER = []
WRAPPER = create_function_tracker(GLOBAL_TOOL_TRACKER)
